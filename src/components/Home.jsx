...
const Home = () => {
  return (
        <div className=' w-full h-screen bg-gray-100 flex flex-col md:flex-row'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col text-[#091E42] justify-center h-full items-center'>
                <h1 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-center'>Trello brings all your tasks, teammates, and tools together</h1>
