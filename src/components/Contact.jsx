...
const Contact = () => {
  return (
    <div name='contact' id='contact' className='w-full h-screen bg-gradient-to-t from-gray-200 to-white flex justify-center items-center p-4 mt-[50rem] md:mt-[15] lg:mt-0'>
